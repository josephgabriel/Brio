      ...
      <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col items-center gap-24 px-6 py-16 text-center">
        <section className="flex flex-col items-center gap-6">
          ...
          <Button size="lg" asChild>
            <Link to={isAuthenticated ? "/dashboard" : "/registro"}>Começar agora</Link>
          </Button>
        </section>
        ...
        <section className="grid w-full grid-cols-1 gap-6 sm:grid-cols-3">
          <Card>
            <CardHeader>
              ...
              <CardTitle className="text-base">Sessões com Pomodoro</CardTitle>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardTitle className="text-base">Revisão espaçada</CardTitle>
            </CardHeader>
            <CardContent className="text-left text-sm text-muted-foreground">
          ...
          <Card>
            <CardHeader>
              ...
              <CardTitle className="text-base">Estatísticas e progresso</CardTitle>
            </CardHeader>
            <CardContent className="text-left text-sm text-muted-foreground">
        ...
        <section className="flex w-full flex-col items-center gap-6">
          <h2 className="text-2xl font-semibold">Planos simples, sem pegadinha</h2>
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <Card className="w-72">
              ...
              <CardContent>
                <p className="mb-4 text-3xl font-semibold">
                  R$ 99,00 <span className="text-sm font-normal text-muted-foreground">/ano</span>
                </p>
                <Button className="w-full" asChild>
                  <Link to="/registro">Começar</Link>
                </Button>
